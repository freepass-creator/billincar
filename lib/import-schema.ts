// billincar — 신규 생성 시 엑셀에 들어가야 할 컬럼 명세
...
export const SNAPSHOT_COLUMNS: ColumnSpec[] = [
  ...
  { label: '등록번호',   field: 'customerIdentNo', required: false, example: '900101-1234567', hint: '주민/사업자/법인 번호 — 자릿수로 개인·사업자·법인 자동 구분 (구분 컬럼 불필요)' },
...
export const CONTRACT_HISTORY_TEMPLATE: HorizontalTemplateSpec = {
  ...
  fixedColumns: [
    ...
    { label: '현재미수',   field: 'currentUnpaid', required: false, example: '0',          hint: '현재 미수 합계 (원). 입력 시 직전 회차부터 역순으로 자동 미납/부분납 처리. 비우면 0' },
  ],
  blockColumns: [
