...
const MOCK_PENDING: Record<string, PendingVehicle[]> = {
  swich: [
    { id: 'pv1', plate: '12가3456', model: '카니발',   carType: '소형승합', contractDocAttached: true,  contractDocName: '계약사실확인서_12가3456.pdf', contractDocUploadedAt: '2026-05-11', purchaseDate: '2026-05-10' },
    { id: 'pv2', plate: '34나5678', model: '포터',     carType: '승용',     contractDocAttached: true,  contractDocName: '계약사실확인서_34나5678.pdf', contractDocUploadedAt: '2026-05-13', purchaseDate: '2026-05-12' },
    { id: 'pv3', plate: '56다7890', model: '모닝',     carType: '승용',     contractDocAttached: false, purchaseDate: '2026-05-20' },
  ],
  evver: [
    { id: 'pv4', plate: '78라9012', model: '스타렉스', carType: '소형승합', contractDocAttached: true, contractDocName: '계약사실확인서_78라9012.pdf', contractDocUploadedAt: '2026-05-19', purchaseDate: '2026-05-18' },
  ],
};
...
const MOCK_COMPANIES: MockCompany[] = [
  {
    ...
    name: '스위치플랜 주식회사',
    branchType: '본점',
    corpRegNo: '110111-8596368',
    bizRegNo: '158-81-03213',
    ceo: '박영현',
    ...
    bizType: '서비스업',
    bizItem: '자동차 임대업',
    establishedDate: '2023-03-30',
    accounts: [
      { id: 'a1', bank: '신한', no: '110-123-456789', holder: '스위치플랜 주식회사' },
      { id: 'a2', bank: '국민', no: 'KB-987-654321', holder: '스위치플랜 주식회사' },
      { id: 'a3', bank: '우리', no: '1002-345-67890', holder: '스위치플랜 주식회사' },
    ],
    cards: [
      { id: 'c1', issuer: '신한', last4: '1234', holder: '스위치플랜 주식회사', type: '신용' },
      { id: 'c2', issuer: '삼성', last4: '5678', holder: '스위치플랜 주식회사', type: '신용' },
      { id: 'c3', issuer: '국민', last4: '9012', holder: '스위치플랜 주식회사', type: '체크/직불' },
    ],
    garages: [
      { id: 'g1', name: '인천 1차고지', address: '인천 남동구 구월동 123', parkingSlots: 20, allowedFleet: 20, currentCount: 18, monthlyRent: 1200000, areaSqm: 660, endDate: '2026-12-31' },
      { id: 'g2', name: '인천 2차고지', address: '인천 부평구 부평동 456', parkingSlots: 15, allowedFleet: 15, currentCount: 12, monthlyRent: 900000, areaSqm: 495, endDate: '2026-05-31' },
      { id: 'g3', name: '김포 차고지', address: '김포시 풍무동 789', parkingSlots: 15, allowedFleet: 15, currentCount: 12, monthlyRent: 800000, areaSqm: 495, endDate: '2027-02-28' },
    ],
    offices: [
      { id: 'o1', name: '본사 사무실', address: '서울 강남구 테헤란로 123, 5층', areaSqm: 165, monthlyRent: 3000000, endDate: '2027-12-31', isHeadquarters: true },
      { id: 'o2', name: '인천 영업소', address: '인천 남동구 구월동 100', areaSqm: 50, monthlyRent: 800000, endDate: '2026-08-31', subBizRegNo: '158-86-03214' },
      { id: 'o3', name: '김포 영업소', address: '김포시 풍무동 50', areaSqm: 40, monthlyRent: 700000, endDate: '2027-05-31', subBizRegNo: '158-86-03215' },
    ],
    fleetApps: [
      { id: 'f1', appliedDate: '2026-05-15', garageName: '인천 1차고지', vehicleCount: 2, status: '관청 접수 중', agency: '인천시청' },
      { id: 'f2', appliedDate: '2026-05-22', garageName: '김포 차고지', vehicleCount: 1, status: '서류 보완 중', agency: '김포시청' },
    ],
    sites: [
      { id: 's1', name: 'GPS 관제', url: 'https://gps.example.com', userId: 'swich_admin', category: 'GPS' },
      { id: 's2', name: '신한 자동이체', url: 'https://www.shinhan.com', userId: '158-81-03213', category: '자동이체' },
      { id: 's3', name: '국세청 홈택스', url: 'https://hometax.go.kr', userId: '158-81-03213', category: '관청' },
      { id: 's4', name: 'KB 손해보험', url: 'https://kbinsure.co.kr', userId: 'swich_ins', category: '보험' },
    ],
    vehicleCount: 42, fleetLimit: 50, operatingCount: 38, pendingPurchase: 3, staffCount: 15, unpaid: 5200000,
    taxExemptCount: 35, taxExemptAmount: 87500000,
  },
  {
    id: 'evver',
    name: '이벤저 주식회사',
    ...
    ceo: '김철수',
    address: '서울특별시 마포구 월드컵북로 50, 3층',
    phone: '02-9876-5432',
    bizType: '서비스업',
    bizItem: '자동차 임대업',
    establishedDate: '2024-01-15',
    accounts: [
      { id: 'a4', bank: '하나', no: '988-12-345678', holder: '이벤저 주식회사' },
      { id: 'a5', bank: '신한', no: '110-555-66677', holder: '이벤저 주식회사' },
    ],
    cards: [
      { id: 'c4', issuer: '하나', last4: '3456', holder: '이벤저 주식회사', type: '신용' },
    ],
    garages: [
      { id: 'g4', name: '부천 차고지', address: '경기 부천시 원미구 123', parkingSlots: 30, allowedFleet: 30, currentCount: 28, monthlyRent: 1800000, areaSqm: 990, endDate: '2026-12-31' },
    ],
    offices: [
      { id: 'o4', name: '본사 사무실', address: '서울 마포구 월드컵북로 50, 3층', areaSqm: 100, monthlyRent: 2500000, endDate: '2027-06-30', isHeadquarters: true },
    ],
    fleetApps: [],
    sites: [
      { id: 's5', name: 'GPS 관제', url: 'https://gps.example.com', userId: 'evver_admin', category: 'GPS' },
      { id: 's6', name: '국세청 홈택스', url: 'https://hometax.go.kr', userId: '234-56-78901', category: '관청' },
    ],
    vehicleCount: 28, fleetLimit: 30, operatingCount: 24, pendingPurchase: 1, staffCount: 9, unpaid: 1200000,
    taxExemptCount: 22, taxExemptAmount: 55000000,
  },
];
